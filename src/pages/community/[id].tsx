...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      ...
      <div className="mb-3 flex cursor-pointer items-center space-x-3 border-b border-t px-4 py-3">
      ...
      <div>
        ...
        <div className="mt-3 flex w-full space-x-5 border-b border-t px-4 py-2.5 text-gray-700">
      ...
      {[1, 2, 3].map((_, i) => (
        <div key={i} className="my-4 space-y-5 px-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-700">
                The best mabndu restaurant is the one next
              </p>
            </div>
          </div>
        </div>
